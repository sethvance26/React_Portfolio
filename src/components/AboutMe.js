    ...
    return (
        <div className="container py-5">
            <div className="row g-0">
                ...
                <p>A Tireless, results-driven Web Developer dedicated to building and optimizing user-focused websites for customers with various business and personal objectives. 
